        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="order-2 md:order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              ...
              <Button asChild variant="ghost" size="lg" className="text-foreground hover:bg-muted font-normal">
            ...
            <div className="mt-16 grid grid-cols-3 gap-8 pt-8 border-t border-border">
              <div className="text-center">
                <div className="text-2xl font-light text-foreground mb-1">150+</div>
              ...
              <div className="text-center">
                <div className="text-2xl font-light text-foreground mb-1">25+</div>
          ...
          <div className="order-1 md:order-2 flex justify-center">
            <div className="relative w-full max-w-md aspect-[4/5]">
              ...
              <div className="relative z-10 p-8 h-full flex items-end">
                <div className="w-full h-64 bg-gradient-to-br from-foreground to-muted-foreground rounded-xl opacity-90"></div>
              </div>
            </div>
          </div>
        </div>
